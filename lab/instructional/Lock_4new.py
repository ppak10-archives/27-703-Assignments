...
def measure_lath(file,ang_step):
    ...
    width_1=0
    width_2= 1024#1024-Univ.of Manchester;1024-rjlee
    Height_2=1024#1024-Univ.of Manchester;1030-rjlee
    ...
    nlm=denoise_nl_means(img1_inv,h=1.15*sigma_est,fast_mode=True,patch_size=5,patch_distance=3,multichannel=True,preserve_range=True).astype('uint8')
    plt.figure(figsize=(10,10))
    plt.title('Skde')
    plt.imshow(nlm)
...
#     
    ...
    plt.axis('off')
    plt.imshow(dst)
    scalebar = ScaleBar(0.0540540540, "um", box_color = None)
